...
class DINetDataset(Dataset):
    def __init__(self,path_json,augment_num,mouth_region_size, is_fine: bool):
    ...
    def __getitem__(self, index):
        ...
        augmented = self.source_transforms(image=source_image_data, masked=source_image_mask)
        source_image_mask = augmented["masked"]
        source_image_data = augmented["image"]

        source_image_data = source_image_data / 255.0
        source_image_mask = source_image_mask / 255.0
